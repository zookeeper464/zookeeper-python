...
def check():
    ...
    tx1,tx2 = sort_x[1:3]
    temp1_1,temp1_2 = ((y1-y2)/(x1-x2))*(tx1-x1)+y2,((y1-y2)/(x1-x2))*(tx2-x1)+y2
    temp2_1,temp2_2 = ((y3-y4)/(x3-x4))*(tx2-x3)+y3,((y3-y4)/(x3-x4))*(tx2-x3)+y3
    if (temp1_1-temp2_1)*(temp2_2-temp1_2)<=0:
